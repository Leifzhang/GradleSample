package com.kronos.gradle.task

import com.kronos.gradle.PluginLogger
import com.kronos.gradle.DepExtension
import com.kronos.gradle.utils.GitUtil
import com.kronos.gradle.utils.Utils
import com.kronos.gradle.utils.Utils.getRemoteDepConfigUrl
...
open class ApplyRemoteDepTask : DefaultTask() {
    ...
    companion object {
        ...
        fun getProjectDepUrls(depExtension: DepExtension): List<String> {
            ...
            val depRemoteConfig = getRemoteDepConfigUrl(curBranch, Utils::getDepRemoteUrl)
